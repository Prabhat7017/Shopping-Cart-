...
const Cart = () => {
  ...
  return (<div className="flex items-start justify-center max-w-4xl mx-auto p-8 mt-24">
    {
      cart.length > 0 ?
        (<div className="flex flex-col lg:flex-row w-full">
          ...
          <div className="lg:ml-8 mt-8 lg:mt-0 p-6 flex flex-col justify-between h-[80vh] w-full lg:w-1/3 lg:sticky lg:top-20">
            ...
            <div className="text-lg text-gray-700 font-semibold">
              <p className="mb-1">Total Amount: <strong className="text-black">${totalAmout.toFixed(2)}</strong></p>
        ...
        (
          <div className="flex items-center justify-center h-screen">
            <div className="flex flex-col items-center">
              ...
              <Link to={"/"}>
                <button className="border birder-gray-300 py-2 px-6 text-[14px] rounded-md text-white font-semibold mt-4 bg-green-600">Shop Now</button>
              </Link>
            </div>
          </div>
        )
